...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_axi_memory_model___stl_sequent__TOP__riscv_muldiv_csr_tb__i_memory__0(Vriscv_muldiv_csr_tb_axi_memory_model* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_muldiv_csr_tb_axi_memory_model___stl_sequent__TOP__riscv_muldiv_csr_tb__i_memory__0\n"); );
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_axi_memory_model___ctor_var_reset(Vriscv_muldiv_csr_tb_axi_memory_model* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_muldiv_csr_tb_axi_memory_model___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_axi_memory_model___configure_coverage(Vriscv_muldiv_csr_tb_axi_memory_model* vlSelf, bool first) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_muldiv_csr_tb_axi_memory_model___configure_coverage\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
