...
#ifndef VERILATED_VRISCV_MULDIV_CSR_TB_RISCV_CORE__M0_MBFFFF_H_
#define VERILATED_VRISCV_MULDIV_CSR_TB_RISCV_CORE__M0_MBFFFF_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vriscv_muldiv_csr_tb_riscv_csr__SB0;
class Vriscv_muldiv_csr_tb_riscv_issue;


class Vriscv_muldiv_csr_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_muldiv_csr_tb_riscv_core__M0_MBffff final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_muldiv_csr_tb_riscv_csr__SB0* u_csr;
    Vriscv_muldiv_csr_tb_riscv_issue* u_issue;
    ...
    // CONSTRUCTORS
    Vriscv_muldiv_csr_tb_riscv_core__M0_MBffff(Vriscv_muldiv_csr_tb__Syms* symsp, const char* v__name);
    ~Vriscv_muldiv_csr_tb_riscv_core__M0_MBffff();
    VL_UNCOPYABLE(Vriscv_muldiv_csr_tb_riscv_core__M0_MBffff);
