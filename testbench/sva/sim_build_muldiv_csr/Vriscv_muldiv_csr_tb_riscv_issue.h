...
#ifndef VERILATED_VRISCV_MULDIV_CSR_TB_RISCV_ISSUE_H_
#define VERILATED_VRISCV_MULDIV_CSR_TB_RISCV_ISSUE_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vriscv_muldiv_csr_tb_riscv_regfile;


class Vriscv_muldiv_csr_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_muldiv_csr_tb_riscv_issue final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_muldiv_csr_tb_riscv_regfile* u_regfile;
    ...
    // CONSTRUCTORS
    Vriscv_muldiv_csr_tb_riscv_issue(Vriscv_muldiv_csr_tb__Syms* symsp, const char* v__name);
    ~Vriscv_muldiv_csr_tb_riscv_issue();
    VL_UNCOPYABLE(Vriscv_muldiv_csr_tb_riscv_issue);
