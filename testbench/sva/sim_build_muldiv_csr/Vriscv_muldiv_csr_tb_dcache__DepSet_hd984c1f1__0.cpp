...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0(Vriscv_muldiv_csr_tb_dcache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_muldiv_csr_tb_dcache___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0\n"); );
    ...
    vlSelfRef.__PVT__mem_uncached_wr_w = ((IData)(vlSelfRef.u_mux__DOT____VdfgRegularize_ha7b7af01_2_1)
                                           ...
                                           : 0U);
    vlSelfRef.__PVT__u_mux__DOT__request_w = ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_rd_w) 
                                              | ((0U 
                                                  != (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_wr_w)) 
    ...
    vlSelfRef.__PVT__mem_uncached_rd_w = ((IData)(vlSelfRef.u_mux__DOT____VdfgRegularize_ha7b7af01_2_1) 
                                          & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_rd_w));
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__1(Vriscv_muldiv_csr_tb_dcache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_muldiv_csr_tb_dcache___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    vlSelfRef.__PVT__mem_accept_o = ((~ (IData)(vlSelfRef.__PVT__u_mux__DOT__hold_w)) 
                                     & ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core.__PVT__u_lsu__DOT__mem_cacheable_q)
                                         ? (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core.__PVT__mem_accept_r)
                                         : ((2U != (IData)(vlSelfRef.__PVT__u_uncached__DOT__u_req__DOT__count_q)) 
                                            & (2U != (IData)(vlSelfRef.__PVT__u_uncached__DOT__u_resp__DOT__count_q)))));
    vlSelfRef.__PVT__u_pmem_mux__DOT__outport_rd_r 
        = ((IData)(vlSelfRef.__PVT__pmem_select_w) ? (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core.__PVT__pmem_rd_w)
...
extern const VlUnpacked<CData/*0:0*/, 512> Vriscv_muldiv_csr_tb__ConstPool__TABLE_hc6b02f5a_0;
extern const VlUnpacked<CData/*0:0*/, 512> Vriscv_muldiv_csr_tb__ConstPool__TABLE_h578b2aa6_0;

VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0(Vriscv_muldiv_csr_tb_dcache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_muldiv_csr_tb_dcache___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    if (vlSymsp->TOP__riscv_muldiv_csr_tb.__PVT__rst) {
        ...
        if (((IData)(vlSelfRef.__PVT__u_uncached__DOT__req_push_w) 
            ...
            __VdlyVal__u_uncached__DOT__u_req__DOT__ram_q__v0[0U] 
                = (IData)((((QData)((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_data_wr_w)) 
            ...
            __VdlyVal__u_uncached__DOT__u_req__DOT__ram_q__v0[2U] 
                = (((IData)(vlSelfRef.__PVT__u_uncached__DOT__drop_req_w) 
        ...
        if (((IData)(vlSelfRef.__PVT__axi_wvalid_o) 
             & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__wready_o))) {
        ...
        if ((((IData)(vlSelfRef.__PVT__axi_awvalid_o) 
              & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__awready_o)) 
        ...
        if (((IData)(vlSelfRef.__PVT__u_mux__DOT__request_w) 
            ...
            vlSelfRef.__PVT__u_mux__DOT__cache_access_q 
                = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core.__PVT__u_lsu__DOT__mem_cacheable_q;
        }
    }
    ...
    vlSelfRef.__PVT__u_pmem_mux__DOT__select_q = ((~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb.__PVT__rst)) 
                                                  & (IData)(vlSelfRef.__PVT__pmem_select_w));
    __Vtableidx1 = ((((0x100U & ((~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__read_active)) 
                                 << 8U)) | (((IData)(vlSelfRef.__PVT__axi_arvalid_o) 
                                             << 7U) 
                                            | ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__wready_o) 
                                               << 6U))) 
                     | (((IData)(vlSelfRef.__PVT__axi_wvalid_o) 
                         << 5U) | ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__awready_o) 
                                   << 4U))) | ((((IData)(vlSelfRef.__PVT__axi_awvalid_o) 
                                               ...
                                               | (((IData)(vlSelfRef.__PVT__u_axi__DOT__req_can_issue_w) 
                                                   << 1U) 
                                                  | (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb.__PVT__rst))));
    if (Vriscv_muldiv_csr_tb__ConstPool__TABLE_hc6b02f5a_0
        [__Vtableidx1]) {
        vlSelfRef.__PVT__u_axi__DOT__u_axi__DOT__valid_q 
            = Vriscv_muldiv_csr_tb__ConstPool__TABLE_h578b2aa6_0
            [__Vtableidx1];
    }
    ...
    vlSelfRef.__PVT__mem_error_o = ((IData)(vlSelfRef.__PVT__u_mux__DOT__cache_access_q) 
                                    && (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core.__PVT__error_q));
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__1(Vriscv_muldiv_csr_tb_dcache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_muldiv_csr_tb_dcache___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    if ((0U != (IData)(vlSelfRef.__PVT__u_mux__DOT__pending_q))) {
        ...
        vlSelfRef.__PVT__pmem_select_w = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core.__PVT__u_lsu__DOT__mem_cacheable_q;
    ...
    u_axi__DOT__u_axi__DOT____VdfgRegularize_he156c47b_0_1 
        = ((IData)(vlSelfRef.__PVT__axi_wvalid_o) & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__wready_o));
    vlSelfRef.__PVT__u_axi__DOT__resp_pop_w = ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__bvalid_o) 
                                               | ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__read_active) 
                                                  & (0U 
                                                     == (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__read_left))));
    vlSelfRef.__PVT__pmem_ack_w = ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__bvalid_o) 
                                   | (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory.__PVT__read_active));
    ...
    vlSelfRef.u_mux__DOT____VdfgRegularize_ha7b7af01_2_1 
        = (1U & ((~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core.__PVT__u_lsu__DOT__mem_cacheable_q)) 
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache___nba_comb__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0(Vriscv_muldiv_csr_tb_dcache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_muldiv_csr_tb_dcache___nba_comb__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__mem_ack_o = ((IData)(vlSelfRef.__PVT__u_mux__DOT__cache_access_q)
                                   ? (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core.__PVT__mem_ack_r)
                                   : (IData)(vlSelfRef.__PVT__mem_uncached_ack_w));
    vlSelfRef.__PVT__u_pmem_mux__DOT__outport_wr_r 
        = ((IData)(vlSelfRef.__PVT__pmem_select_w) ? (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core.__PVT__pmem_wr_w)
