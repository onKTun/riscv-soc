...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___nba_sequent__TOP__riscv_muldiv_csr_tb__d_memory__0(Vriscv_muldiv_csr_tb_axi_memory_model__R80000104* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___nba_sequent__TOP__riscv_muldiv_csr_tb__d_memory__0\n"); );
    ...
    if (vlSymsp->TOP__riscv_muldiv_csr_tb.__PVT__rst) {
        ...
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wvalid_o) 
             & (IData)(vlSelfRef.__PVT__wready_o))) {
            __Vdly__write_words_o = ((IData)(1U) + vlSelfRef.__PVT__write_words_o);
            if (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wlast_o) {
                __Vdly__bvalid_o = 1U;
            }
        }
        ...
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_arvalid_o) 
             & (~ (IData)(vlSelfRef.__PVT__read_active)))) {
            __Vdly__read_bursts_o = ((IData)(1U) + vlSelfRef.__PVT__read_bursts_o);
            vlSelfRef.__PVT__read_id = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awid_o;
        }
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awvalid_o) 
             & (IData)(vlSelfRef.__PVT__awready_o))) {
            vlSelfRef.__PVT__write_addr = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awaddr_o;
        }
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wvalid_o) 
             & (IData)(vlSelfRef.__PVT__wready_o))) {
            if ((1U & (~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wlast_o)))) {
            ...
            if (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wlast_o) {
                vlSelfRef.__PVT__bid_o = ((IData)(vlSelfRef.__PVT__write_active)
                                           ...
                                           : (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awid_o));
            }
        }
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awvalid_o) 
             & (IData)(vlSelfRef.__PVT__awready_o))) {
            vlSelfRef.__PVT__write_id = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awid_o;
        ...
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wvalid_o) 
            ...
            if ((0x80000104U == vlSelfRef.__PVT__active_write_addr)) {
                ...
                vlSelfRef.__PVT__result_data_o = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wdata_o;
            }
            vlSelfRef.__PVT__write_active = (1U & (~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wlast_o)));
        }
    }
    if ((1U & (~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb.__PVT__rst)))) {
        if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wvalid_o) 
             & (IData)(vlSelfRef.__PVT__wready_o))) {
            if ((0x400U > (vlSelfRef.__PVT__active_write_addr 
                           >> 2U))) {
                if ((1U & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wstrb_o))) {
                    __VdlyVal__mem__v0 = (0xffU & vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wdata_o);
                    __VdlyDim0__mem__v0 = (0x3ffU & 
                                           (vlSelfRef.__PVT__active_write_addr 
                                            >> 2U));
                    __VdlySet__mem__v0 = 1U;
                }
                if ((2U & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wstrb_o))) {
                    __VdlyVal__mem__v1 = (0xffU & (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wdata_o 
                                                   >> 8U));
                ...
                if ((4U & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wstrb_o))) {
                    __VdlyVal__mem__v2 = (0xffU & (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wdata_o 
                                                   >> 0x10U));
                ...
                if ((8U & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wstrb_o))) {
                    __VdlyVal__mem__v3 = (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_wdata_o 
                                          >> 0x18U);
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___nba_sequent__TOP__riscv_muldiv_csr_tb__d_memory__1(Vriscv_muldiv_csr_tb_axi_memory_model__R80000104* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___nba_sequent__TOP__riscv_muldiv_csr_tb__d_memory__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    } else if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_arvalid_o) 
                & (IData)(vlSelfRef.__PVT__arready_o))) {
        vlSelfRef.__PVT__read_active = 1U;
        vlSelfRef.__Vdly__read_addr = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awaddr_o;
        vlSelfRef.__Vdly__read_left = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__axi_awlen_o;
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___nba_sequent__TOP__riscv_muldiv_csr_tb__d_memory__2(Vriscv_muldiv_csr_tb_axi_memory_model__R80000104* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___nba_sequent__TOP__riscv_muldiv_csr_tb__d_memory__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
