...
#ifndef VERILATED_VRISCV_MULDIV_CSR_TB_DCACHE_CORE_H_
#define VERILATED_VRISCV_MULDIV_CSR_TB_DCACHE_CORE_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vriscv_muldiv_csr_tb_dcache_core_data_ram;
class Vriscv_muldiv_csr_tb_dcache_core_tag_ram;


class Vriscv_muldiv_csr_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_muldiv_csr_tb_dcache_core final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_muldiv_csr_tb_dcache_core_tag_ram* u_tag0;
    Vriscv_muldiv_csr_tb_dcache_core_tag_ram* u_tag1;
    Vriscv_muldiv_csr_tb_dcache_core_data_ram* u_data0;
    Vriscv_muldiv_csr_tb_dcache_core_data_ram* u_data1;
    ...
    // CONSTRUCTORS
    Vriscv_muldiv_csr_tb_dcache_core(Vriscv_muldiv_csr_tb__Syms* symsp, const char* v__name);
    ~Vriscv_muldiv_csr_tb_dcache_core();
    VL_UNCOPYABLE(Vriscv_muldiv_csr_tb_dcache_core);
