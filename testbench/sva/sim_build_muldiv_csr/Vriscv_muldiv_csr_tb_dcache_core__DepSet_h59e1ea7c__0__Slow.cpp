...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_dcache_core___ctor_var_reset(Vriscv_muldiv_csr_tb_dcache_core* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___ctor_var_reset\n"); );
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_dcache_core___configure_coverage(Vriscv_muldiv_csr_tb_dcache_core* vlSelf, bool first) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___configure_coverage\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
