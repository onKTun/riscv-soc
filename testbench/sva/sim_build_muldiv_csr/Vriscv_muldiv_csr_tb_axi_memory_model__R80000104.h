...
#ifndef VERILATED_VRISCV_MULDIV_CSR_TB_AXI_MEMORY_MODEL__R80000104_H_
#define VERILATED_VRISCV_MULDIV_CSR_TB_AXI_MEMORY_MODEL__R80000104_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vriscv_muldiv_csr_tb_axi_memory_model__R80000104 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vriscv_muldiv_csr_tb_axi_memory_model__R80000104(Vriscv_muldiv_csr_tb__Syms* symsp, const char* v__name);
    ~Vriscv_muldiv_csr_tb_axi_memory_model__R80000104();
    VL_UNCOPYABLE(Vriscv_muldiv_csr_tb_axi_memory_model__R80000104);
