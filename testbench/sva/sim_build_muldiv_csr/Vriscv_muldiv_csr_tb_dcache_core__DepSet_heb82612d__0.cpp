...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache_core___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0(Vriscv_muldiv_csr_tb_dcache_core* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0\n"); );
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache_core___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__1(Vriscv_muldiv_csr_tb_dcache_core* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___ico_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((3U == (IData)(vlSelfRef.__PVT__state_q))) {
        vlSelfRef.__PVT__mem_accept_r = (1U & ((~ (
                                               ...
                                               & (~ 
                                                  (((0U 
                                                     != (IData)(vlSelfRef.__PVT__mem_wr_m_q)) 
                                                    & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_rd_w)) 
                                                   & ((vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_addr_w 
                                                       >> 2U) 
                                                      == 
    ...
    if ((8U & (IData)(vlSelfRef.__PVT__state_q))) {
        if ((1U & (~ ((IData)(vlSelfRef.__PVT__state_q) 
            ...
            } else if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_ack_w) 
                        & (IData)(vlSelfRef.__PVT__mem_writeback_m_q))) {
                vlSelfRef.__PVT__next_state_r = 3U;
            } else if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_ack_w) 
                        & (IData)(vlSelfRef.__PVT__flushing_q))) {
                vlSelfRef.__PVT__next_state_r = 1U;
            } else if (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_ack_w) {
        ...
        if ((2U & (IData)(vlSelfRef.__PVT__state_q))) {
            if ((1U & (IData)(vlSelfRef.__PVT__state_q))) {
                if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w) 
        ...
        if ((1U & (IData)(vlSelfRef.__PVT__state_q))) {
            if ((((IData)(vlSelfRef.__PVT__mem_rd_m_q) 
                ...
                vlSelfRef.__PVT__next_state_r = ((IData)(vlSelfRef.__PVT__evict_way_w)
                                                  ? 7U
                                                  : 6U);
            } else if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_writeback_w) 
                        & (IData)(vlSelfRef.__PVT__mem_accept_r))) {
                vlSelfRef.__PVT__next_state_r = 0xaU;
            } else if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_flush_w) 
                        & (IData)(vlSelfRef.__PVT__mem_accept_r))) {
                vlSelfRef.__PVT__next_state_r = 1U;
            } else if (((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_invalidate_w) 
                        & (IData)(vlSelfRef.__PVT__mem_accept_r))) {
    ...
    vlSelfRef.__PVT__tag_addr_x_r = (0xffU & (((3U 
                                               ...
                                               : ((IData)(vlSelfRef.__PVT__flushing_q)
                                                  ...
                                                  (vlSelfRef.__PVT__mem_addr_m_q 
                                                   >> 5U))));
    vlSelfRef.__PVT__data_addr_x_r = (0x7ffU & (vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_addr_w 
                                                >> 2U));
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache_core___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0(Vriscv_muldiv_csr_tb_dcache_core* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache_core___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__1(Vriscv_muldiv_csr_tb_dcache_core* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___nba_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    if (vlSymsp->TOP__riscv_muldiv_csr_tb.__PVT__rst) {
        ...
        if (((0U != ((IData)(vlSelfRef.__VdfgRegularize_h82da71bd_1_2)
                      ? 7U : 0U)) & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w))) {
            __Vdly__pmem_addr_q = ((IData)(4U) + vlSelfRef.__PVT__pmem_addr_w);
        } else if (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w) {
        ...
        if (((6U != (IData)(vlSelfRef.__PVT__state_q)) 
            ...
            __Vdly__data_write_addr_q = (0x7ffU & ((IData)(1U) 
                    ...
                    & (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w))) {
            __Vdly__data_write_addr_q = (0x7ffU & ((IData)(1U) 
                                                   + (IData)(vlSelfRef.__PVT__data_write_addr_q)));
        }
        if (((7U != (IData)(vlSelfRef.__PVT__state_q)) 
            ...
            if (vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w) {
                vlSelfRef.__PVT__pmem_wr0_q = 0U;
            }
        }
        ...
        if ((1U & (~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w)))) {
        ...
        if (vlSelfRef.__PVT__pmem_rd_w) {
            vlSelfRef.__PVT__pmem_rd_q = (1U & (~ (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__pmem_cache_accept_w)));
        }
        if (vlSelfRef.__PVT__mem_accept_r) {
            vlSelfRef.__PVT__mem_tag_m_q = 0U;
            vlSelfRef.__PVT__mem_data_m_q = vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_data_wr_w;
            vlSelfRef.__PVT__mem_inval_m_q = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_invalidate_w;
            vlSelfRef.__PVT__mem_flush_m_q = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_flush_w;
            vlSelfRef.__PVT__mem_writeback_m_q = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_writeback_w;
            vlSelfRef.__PVT__mem_rd_m_q = vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.__PVT__mem_cached_rd_w;
            vlSelfRef.__PVT__mem_wr_m_q = ((IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache.u_mux__DOT____VdfgRegularize_ha7b7af01_2_4)
                                            ? (IData)(vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_wr_w)
                                            : 0U);
            vlSelfRef.__PVT__mem_addr_m_q = vlSymsp->TOP__riscv_muldiv_csr_tb__dut.dcache_addr_w;
...
VL_INLINE_OPT void Vriscv_muldiv_csr_tb_dcache_core___nba_comb__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0(Vriscv_muldiv_csr_tb_dcache_core* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_muldiv_csr_tb_dcache_core___nba_comb__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
