...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb___024root____Vm_traceActivitySetAll(Vriscv_muldiv_csr_tb___024root* vlSelf);

VL_ATTR_COLD void Vriscv_muldiv_csr_tb___024root___eval_static(Vriscv_muldiv_csr_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vriscv_muldiv_csr_tb___024root___eval_static\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vriscv_muldiv_csr_tb_riscv_muldiv_csr_tb___eval_static__TOP__riscv_muldiv_csr_tb((&vlSymsp->TOP__riscv_muldiv_csr_tb));
    Vriscv_muldiv_csr_tb___024root____Vm_traceActivitySetAll(vlSelf);
}
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb___024root___eval_final(Vriscv_muldiv_csr_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vriscv_muldiv_csr_tb___024root___eval_final\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vriscv_muldiv_csr_tb_riscv_top__M0_MBffff___eval_final__TOP__riscv_muldiv_csr_tb__dut((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut));
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vriscv_muldiv_csr_tb___024root___dump_triggers__stl(Vriscv_muldiv_csr_tb___024root* vlSelf);
#endif  // VL_DEBUG

VL_ATTR_COLD void Vriscv_muldiv_csr_tb___024root___eval_triggers__stl(Vriscv_muldiv_csr_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vriscv_muldiv_csr_tb___024root___eval_triggers__stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VstlTriggered.set(0U, (IData)(vlSelfRef.__VstlFirstIteration));
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vriscv_muldiv_csr_tb___024root___dump_triggers__stl(vlSelf);
    }
#endif
}

VL_ATTR_COLD void Vriscv_muldiv_csr_tb_axi_memory_model___stl_sequent__TOP__riscv_muldiv_csr_tb__i_memory__0(Vriscv_muldiv_csr_tb_axi_memory_model* vlSelf);
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_dcache___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0(Vriscv_muldiv_csr_tb_dcache* vlSelf);
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_riscv_csr_regfile___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__u_csrfile__0(Vriscv_muldiv_csr_tb_riscv_csr_regfile* vlSelf);
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_icache___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_icache__0(Vriscv_muldiv_csr_tb_icache* vlSelf);
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_riscv_csr_regfile___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__u_csrfile__1(Vriscv_muldiv_csr_tb_riscv_csr_regfile* vlSelf);
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb_dcache___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__1(Vriscv_muldiv_csr_tb_dcache* vlSelf);
...
VL_ATTR_COLD void Vriscv_muldiv_csr_tb___024root___eval_stl(Vriscv_muldiv_csr_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_muldiv_csr_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vriscv_muldiv_csr_tb___024root___eval_stl\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vriscv_muldiv_csr_tb_axi_memory_model___stl_sequent__TOP__riscv_muldiv_csr_tb__i_memory__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__i_memory));
        Vriscv_muldiv_csr_tb___024root____Vm_traceActivitySetAll(vlSelf);
        Vriscv_muldiv_csr_tb_riscv_top__M0_MBffff___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut));
        Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___stl_sequent__TOP__riscv_muldiv_csr_tb__d_memory__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory));
        Vriscv_muldiv_csr_tb_dcache___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache));
        Vriscv_muldiv_csr_tb_riscv_core__M0_MBffff___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core));
        Vriscv_muldiv_csr_tb_riscv_csr_regfile___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__u_csrfile__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__u_csrfile));
        Vriscv_muldiv_csr_tb_icache___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_icache__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_icache));
        Vriscv_muldiv_csr_tb_riscv_csr__SB0___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr));
        Vriscv_muldiv_csr_tb_dcache_core___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache__u_core));
        Vriscv_muldiv_csr_tb_riscv_issue___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__u_issue__0((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core__u_issue));
        Vriscv_muldiv_csr_tb_axi_memory_model__R80000104___stl_sequent__TOP__riscv_muldiv_csr_tb__d_memory__1((&vlSymsp->TOP__riscv_muldiv_csr_tb__d_memory));
        ...
        Vriscv_muldiv_csr_tb_riscv_csr_regfile___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__u_csrfile__1((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_core__u_csr__u_csrfile));
        ...
        Vriscv_muldiv_csr_tb_dcache___stl_sequent__TOP__riscv_muldiv_csr_tb__dut__u_dcache__1((&vlSymsp->TOP__riscv_muldiv_csr_tb__dut__u_dcache));
