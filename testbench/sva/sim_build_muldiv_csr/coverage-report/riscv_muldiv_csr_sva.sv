//      // verilator_coverage annotation
 ...
 000005     CHK_017_mul_result_valid_C: cover property (
 ...
 000001     CHK_020_mulhu_unsigned_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
 ...
 000001     CHK_021_mulhsu_mixed_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
 ...
 000001     CHK_022_mul_zero_id_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
                ...
                div_writeback_valid && (div_rb_latched == 32'b0) |->
                    ( (div_is_div_latched  && (div_writeback_value == 32'hFFFFFFFF)) ||
                      ...
                      (div_is_remu_latched && (div_writeback_value == div_ra_latched)) )
                           ...
                           div_writeback_value);
 000004     CHK_023_div_by_zero_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
                ...
                (div_ra_latched == 32'h80000000) && (div_rb_latched == 32'hFFFFFFFF) |->
                    ( (div_is_div_latched && (div_writeback_value == 32'h80000000)) ||
                      (div_is_rem_latched && (div_writeback_value == 32'b0)) )
                           ...
                           div_writeback_value);
 000002     CHK_024_div_overflow_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
                ...
                div_writeback_valid |->
                    ( (div_is_div_latched  && (div_writeback_value == div_ref_q)) ||
                      ...
                      (div_is_remu_latched && (div_writeback_value == divu_ref_r)) )
                           ...
                           div_writeback_value);
 000004     CHK_025_div_result_correct_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
                div_writeback_valid && (div_rb_latched != 32'b0) &&
                !((div_ra_latched == 32'h80000000) && (div_rb_latched == 32'hFFFFFFFF))
            );
 ...
 000330     CHK_026_div_busy_no_new_issue_C: cover property (
 ...
 000010     CHK_027_div_valid_pulse_C: cover property (
 ...
 000002     CHK_028_csr_write_readback_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
                csr_result_e1_write
            );
...
%000000     CHK_029_illegal_csr_exception_C: cover property (
                @(posedge clk_i) disable iff (rst_i)
...
%000000     CHK_030_mepc_capture_C: cover property (
