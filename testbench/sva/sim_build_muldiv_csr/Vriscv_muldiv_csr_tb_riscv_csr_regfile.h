...
#ifndef VERILATED_VRISCV_MULDIV_CSR_TB_RISCV_CSR_REGFILE_H_
#define VERILATED_VRISCV_MULDIV_CSR_TB_RISCV_CSR_REGFILE_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vriscv_muldiv_csr_tb_riscv_csr_regfile final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vriscv_muldiv_csr_tb_riscv_csr_regfile(Vriscv_muldiv_csr_tb__Syms* symsp, const char* v__name);
    ~Vriscv_muldiv_csr_tb_riscv_csr_regfile();
    VL_UNCOPYABLE(Vriscv_muldiv_csr_tb_riscv_csr_regfile);
