...
#ifndef VERILATED_VRISCV_TOP_TB_AXI_MEMORY_MODEL_H_
#define VERILATED_VRISCV_TOP_TB_AXI_MEMORY_MODEL_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_tb_axi_memory_model final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vriscv_top_tb_axi_memory_model(Vriscv_top_tb__Syms* symsp, const char* v__name);
    ~Vriscv_top_tb_axi_memory_model();
    VL_UNCOPYABLE(Vriscv_top_tb_axi_memory_model);
