...
#ifndef VERILATED_VRISCV_TOP_TB_ICACHE_H_
#define VERILATED_VRISCV_TOP_TB_ICACHE_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vriscv_top_tb_icache_data_ram;
class Vriscv_top_tb_icache_tag_ram;


class Vriscv_top_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_tb_icache final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_top_tb_icache_tag_ram* u_tag0;
    Vriscv_top_tb_icache_tag_ram* u_tag1;
    Vriscv_top_tb_icache_data_ram* u_data0;
    Vriscv_top_tb_icache_data_ram* u_data1;
    ...
    // CONSTRUCTORS
    Vriscv_top_tb_icache(Vriscv_top_tb__Syms* symsp, const char* v__name);
    ~Vriscv_top_tb_icache();
    VL_UNCOPYABLE(Vriscv_top_tb_icache);
