...
VL_INLINE_OPT void Vriscv_top_tb_icache___nba_sequent__TOP__riscv_top_tb__dut__u_icache__0(Vriscv_top_tb_icache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_top_tb_icache___nba_sequent__TOP__riscv_top_tb__dut__u_icache__0\n"); );
    ...
    if (vlSymsp->TOP__riscv_top_tb.__PVT__rst) {
        ...
        if (((IData)(vlSymsp->TOP__riscv_top_tb__dut__u_core.__PVT__mem_i_rd_o) 
...
VL_INLINE_OPT void Vriscv_top_tb_icache___nba_sequent__TOP__riscv_top_tb__dut__u_icache__1(Vriscv_top_tb_icache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_top_tb_icache___nba_sequent__TOP__riscv_top_tb__dut__u_icache__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    } else if (((IData)(vlSymsp->TOP__riscv_top_tb__dut__u_core.__PVT__mem_i_rd_o) 
                & (IData)(vlSelfRef.__PVT__req_accept_o))) {
...
VL_INLINE_OPT void Vriscv_top_tb_icache___nba_sequent__TOP__riscv_top_tb__dut__u_icache__2(Vriscv_top_tb_icache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_top_tb_icache___nba_sequent__TOP__riscv_top_tb__dut__u_icache__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void Vriscv_top_tb_icache___nba_comb__TOP__riscv_top_tb__dut__u_icache__0(Vriscv_top_tb_icache* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vriscv_top_tb_icache___nba_comb__TOP__riscv_top_tb__dut__u_icache__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
