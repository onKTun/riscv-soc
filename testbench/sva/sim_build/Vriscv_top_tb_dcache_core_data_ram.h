...
#ifndef VERILATED_VRISCV_TOP_TB_DCACHE_CORE_DATA_RAM_H_
#define VERILATED_VRISCV_TOP_TB_DCACHE_CORE_DATA_RAM_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_tb_dcache_core_data_ram final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vriscv_top_tb_dcache_core_data_ram(Vriscv_top_tb__Syms* symsp, const char* v__name);
    ~Vriscv_top_tb_dcache_core_data_ram();
    VL_UNCOPYABLE(Vriscv_top_tb_dcache_core_data_ram);
