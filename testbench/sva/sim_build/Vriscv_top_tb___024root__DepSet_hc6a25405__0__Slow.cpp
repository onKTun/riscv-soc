...
VL_ATTR_COLD void Vriscv_top_tb___024root___eval_stl(Vriscv_top_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vriscv_top_tb_riscv_top_tb___stl_sequent__TOP__riscv_top_tb__0((&vlSymsp->TOP__riscv_top_tb));
        Vriscv_top_tb___024root____Vm_traceActivitySetAll(vlSelf);
        ...
        Vriscv_top_tb_riscv_top_tb___stl_sequent__TOP__riscv_top_tb__1((&vlSymsp->TOP__riscv_top_tb));
        Vriscv_top_tb_riscv_core__M0_MBffff___stl_sequent__TOP__riscv_top_tb__dut__u_core__1((&vlSymsp->TOP__riscv_top_tb__dut__u_core));
        ...
        Vriscv_top_tb_riscv_issue___stl_sequent__TOP__riscv_top_tb__dut__u_core__u_issue__1((&vlSymsp->TOP__riscv_top_tb__dut__u_core__u_issue));
        ...
        Vriscv_top_tb_riscv_core__M0_MBffff___stl_sequent__TOP__riscv_top_tb__dut__u_core__2((&vlSymsp->TOP__riscv_top_tb__dut__u_core));
        Vriscv_top_tb_riscv_issue___stl_sequent__TOP__riscv_top_tb__dut__u_core__u_issue__2((&vlSymsp->TOP__riscv_top_tb__dut__u_core__u_issue));
