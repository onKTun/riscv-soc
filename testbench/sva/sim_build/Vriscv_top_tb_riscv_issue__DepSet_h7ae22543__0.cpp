...
bool Vriscv_top_tb_riscv_issue::complete_valid0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_valid0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_pc0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_pc0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_opcode0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_opcode0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_ra0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_ra0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_rb0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_rb0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_rd0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_rd0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_ra_val0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_ra_val0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_rb_val0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_rb_val0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_rd_val0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_rd_val0\n"); );
...
uint32_t Vriscv_top_tb_riscv_issue::complete_exception() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_issue::complete_exception\n"); );
