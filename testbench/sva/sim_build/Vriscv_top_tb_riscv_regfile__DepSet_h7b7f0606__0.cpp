...
uint32_t Vriscv_top_tb_riscv_regfile::REGFILE__DOT__get_register(uint32_t r) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vriscv_top_tb_riscv_regfile::REGFILE__DOT__get_register\n"); );
...
bool Vriscv_top_tb_riscv_regfile::REGFILE__DOT__set_register(uint32_t r, uint32_t value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vriscv_top_tb_riscv_regfile::REGFILE__DOT__set_register\n"); );
