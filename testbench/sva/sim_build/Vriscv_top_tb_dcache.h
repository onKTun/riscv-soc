...
#ifndef VERILATED_VRISCV_TOP_TB_DCACHE_H_
#define VERILATED_VRISCV_TOP_TB_DCACHE_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vriscv_top_tb_dcache_core;


class Vriscv_top_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_tb_dcache final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_top_tb_dcache_core* u_core;
    ...
    // CONSTRUCTORS
    Vriscv_top_tb_dcache(Vriscv_top_tb__Syms* symsp, const char* v__name);
    ~Vriscv_top_tb_dcache();
    VL_UNCOPYABLE(Vriscv_top_tb_dcache);
