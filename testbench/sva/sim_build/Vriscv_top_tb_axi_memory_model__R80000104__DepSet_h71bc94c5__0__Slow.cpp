...
VL_ATTR_COLD void Vriscv_top_tb_axi_memory_model__R80000104___stl_sequent__TOP__riscv_top_tb__d_memory__0(Vriscv_top_tb_axi_memory_model__R80000104* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_top_tb_axi_memory_model__R80000104___stl_sequent__TOP__riscv_top_tb__d_memory__0\n"); );
...
VL_ATTR_COLD void Vriscv_top_tb_axi_memory_model__R80000104___ctor_var_reset(Vriscv_top_tb_axi_memory_model__R80000104* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_top_tb_axi_memory_model__R80000104___ctor_var_reset\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vriscv_top_tb_axi_memory_model__R80000104___configure_coverage(Vriscv_top_tb_axi_memory_model__R80000104* vlSelf, bool first) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_top_tb_axi_memory_model__R80000104___configure_coverage\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
