...
VL_INLINE_OPT void Vriscv_top_tb_axi_memory_model___nba_sequent__TOP__riscv_top_tb__i_memory__0(Vriscv_top_tb_axi_memory_model* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vriscv_top_tb_axi_memory_model___nba_sequent__TOP__riscv_top_tb__i_memory__0\n"); );
    ...
    if (vlSymsp->TOP__riscv_top_tb.__PVT__rst) {
        ...
        if (((IData)(vlSymsp->TOP__riscv_top_tb__dut__u_icache.__PVT__axi_arvalid_o) 
            ...
            __Vdly__read_addr = (0xffffffe0U & vlSymsp->TOP__riscv_top_tb__dut__u_icache.__PVT__lookup_addr_q);
