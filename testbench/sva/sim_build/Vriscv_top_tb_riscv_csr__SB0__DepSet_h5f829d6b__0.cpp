...
VL_INLINE_OPT void Vriscv_top_tb_riscv_csr__SB0___nba_sequent__TOP__riscv_top_tb__dut__u_core__u_csr__2(Vriscv_top_tb_riscv_csr__SB0* vlSelf) {
    ...
    if (vlSymsp->TOP__riscv_top_tb.__PVT__rst) {
        ...
        if (vlSymsp->TOP__riscv_top_tb__dut__u_core__u_issue.__PVT__csr_opcode_valid_o) {
...
VL_INLINE_OPT void Vriscv_top_tb_riscv_csr__SB0___nba_comb__TOP__riscv_top_tb__dut__u_core__u_csr__0(Vriscv_top_tb_riscv_csr__SB0* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vriscv_top_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vriscv_top_tb_riscv_csr__SB0___nba_comb__TOP__riscv_top_tb__dut__u_core__u_csr__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
