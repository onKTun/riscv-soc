...
#ifndef VERILATED_VRISCV_TOP_TB_RISCV_CSR__SB0_H_
#define VERILATED_VRISCV_TOP_TB_RISCV_CSR__SB0_H_  // guard

#include "verilated.h"
#include "verilated_cov.h"
#include "verilated_timing.h"
class Vriscv_top_tb_riscv_csr_regfile;


class Vriscv_top_tb__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vriscv_top_tb_riscv_csr__SB0 final : public VerilatedModule {
  public:
    // CELLS
    Vriscv_top_tb_riscv_csr_regfile* u_csrfile;
    ...
    // CONSTRUCTORS
    Vriscv_top_tb_riscv_csr__SB0(Vriscv_top_tb__Syms* symsp, const char* v__name);
    ~Vriscv_top_tb_riscv_csr__SB0();
    VL_UNCOPYABLE(Vriscv_top_tb_riscv_csr__SB0);
